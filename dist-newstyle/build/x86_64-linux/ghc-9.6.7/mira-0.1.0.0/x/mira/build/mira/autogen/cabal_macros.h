...
/* package mira-0.1.0.0 */
#ifndef VERSION_mira
#define VERSION_mira "0.1.0.0"
#endif /* VERSION_mira */
#ifndef MIN_VERSION_mira
#define MIN_VERSION_mira(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mira */
...
#define CURRENT_COMPONENT_ID "mira-0.1.0.0-inplace-mira"
